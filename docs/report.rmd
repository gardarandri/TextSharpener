...
Formally, if we
let $F_theta$ be the neural network which unblurrs images,
...
![Left column: The blurred image, Middle column: The original image, Right column: The outputted image](iter3100.png)
